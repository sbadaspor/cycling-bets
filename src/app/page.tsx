...
function EmptyStateProxima({
  ...
  return (
    <div className="card" style={{ textAlign: 'center', padding: '2.5rem 1.5rem', background: 'linear-gradient(135deg, rgba(200,244,0,0.04) 0%, transparent 60%)' }}>
      <div style={{ fontSize: '2.5rem', marginBottom: '0.75rem' }}>⏳</div>
      <p style={{ fontSize: '0.75rem', color: 'var(--lime)', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '0.4rem' }}>A aguardar resultados</p>
      ...
      {userId && (
        <a href={`/apostas/${proxima.id}`} style={{ display: 'inline-block', background: 'rgba(200,244,0,0.9)', color: '#0a0a0a', padding: '0.6rem 1.5rem', borderRadius: '0.75rem', fontSize: '0.875rem', fontWeight: 700, textDecoration: 'none' }}>
          Fazer aposta →
        </a>
      )}
    </div>
